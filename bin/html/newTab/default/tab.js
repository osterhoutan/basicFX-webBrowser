function updateClock(){
  var currentTime = new Date(),
    ...
    currentMonth = ('0'+currentTime.getMonth()).slice(-2),
    currentDate = ('0'+currentTime.getDate()).slice(-2), 
    currentDay = currentTime.getDay();
  document.getElementById("clock").innerHTML = currentHours + ':' + currentMinutes;
  document.getElementById("date").innerHTML = currentYear + '-' + currentMonth + '-' + currentDate;
}
